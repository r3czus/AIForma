    ...
    : IdentityDbContext<ApplicationUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<UserProfile>(profile =>
        {
            ...
            profile.Property(x => x.WeeklyWeightChangeKg).HasPrecision(4, 2);
        ...
        builder.Entity<Exercise>(exercise =>
        {
            ...
            exercise.HasData(
                ...
                new { Id = Guid.Parse("10000000-0000-0000-0000-000000000006"), OwnerUserId = (string?)null, Name = "Podciąganie", PrimaryMuscleGroup = MuscleGroup.Back, Equipment = Equipment.Bodyweight, IsUnilateral = false, IsActive = true, CreatedAtUtc = seededAt, UpdatedAtUtc = seededAt, MediaExternalUrl = "https://commons.wikimedia.org/wiki/Special:Redirect/file/Weighted%2C_wide-grip_pullup_video.gif", MediaContentType = "image/gif", MediaAttribution = "Extremistpullup · domena publiczna", MediaSourceUrl = "https://commons.wikimedia.org/wiki/File:Weighted,_wide-grip_pullup_video.gif", MediaStorageName = (string?)null });
        });
