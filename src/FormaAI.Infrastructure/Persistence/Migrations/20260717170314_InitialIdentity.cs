        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartingWeightKg = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    Goal = table.Column<int>(type: "int", nullable: true),
                    PlannedTrainingsPerWeek = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
